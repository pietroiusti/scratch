...
// Prints the events of device (supplied as the first argumement).
//
// Usage example:
//   $ print_events /dev/input/event6
//
// Compile with:
//   gcc `pkg-config --cflags libevdev` ./01_print_events.c `pkg-config --libs libevdev` -o foobar
